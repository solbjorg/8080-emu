...
void disassemble(uint8_t *buffer, uint16_t length) {
  uint16_t pc = 0;
  while (pc < length) {
    uint16_t bytesize = 1;
    ...
    case 0x26:
      ...
      bytesize = 2;
      break; // loads immediate into L, not H
    case 0x27:
      printf("DAA");
      break;
    case 0x28:
    ...
    case 0x39:
      ...
      break;
    case 0x3A:
      printf("LDA A, $%02x%02x", instruction[2], instruction[1]);
      bytesize = 3;
      break;
    case 0x3B:
      printf("DCX SP");
    ...
    case 0x76:
      printf("HLT");
      break; // why is this in the middle of the mov ops where M, M should be?
    case 0x77:
      printf("MOV M, A");
      break;
    ...
    case 0xea:
      ...
      break;
    case 0xeb:
      printf("XCHG"); // exchanges D and H register pairs
      break;
    case 0xec:
